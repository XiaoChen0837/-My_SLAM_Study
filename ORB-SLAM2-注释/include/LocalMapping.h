...
/*
    LocalMapping 顾名思义就是局部地图的意思。从这张框架图可以看出，LocalMapping线程在系统中通过关键帧将Tracking线程和Loop closing线程连接了起来：
    将Tracking线程中生成的关键帧在LocalMapping线程中经过相关处理后，再转给LoopCLosing线程进行处理。
