...
void KeyFrame::UpdateConnections()
{
    ...
    */
    ...
    // vPairs里存的都是相互共视程度比较高的关键帧和共视权重，由大到小  进行排序
    sort(vPairs.begin(),vPairs.end());
    list<KeyFrame*> lKFs;
    list<int> lWs;
    ...
    //===============3==================================
    {
        ...
        // 更新图的连接(权重)  mConnectedKeyFrameWeights中存储的是哪些keyframe和当前帧可以共同观察到的mappoint的个数
        ...
        // 更新生成树的连接   mbFirstConnection值在初始化KeyFrame的时候置为true
